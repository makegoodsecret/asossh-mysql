...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        if(AlipayConfig.sign_type.equals("MD5") ) {
        	Logger  logger =Logger.getLogger(AlipaySubmit.class.getName());
        	//logger.info("new AlipayConfig().key="+new AlipayConfig().key);
        	mysign = MD5.sign(prestr, new AlipayConfig().key, AlipayConfig.input_charset);
        }
        return mysign;
    }
	...
	public static String query_timestamp() throws MalformedURLException,
        ...
        String strUrl = ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner=" + new AlipayConfig().partner + "&_input_charset" +AlipayConfig.input_charset;
