...
<meta http-equiv="pragma" content="no-cache">
	...
	function subads(){
			messagerShow('正在保存');
			myform1.action="<%=basePath %>asossh/ads!save.action";
			myform1.submit();
	}
	</script>
</head> 
<body  background="<%=basePath %>image/bg.jpg"  >
	...
	<form name="myform1" id="myform1"  action="<%=basePath %>asossh/ads!save.action" class="formgoodsup" method="post"  enctype="multipart/form-data" >
	<table background="<%=basePath %>image/bg.jpg" align="center" width="90%" border="0">
		<tr><td colspan="2">
			<table align="center" width="100%">
				<tr align="center"><td><font size="6">上传广告</font></td></tr>
		...
		<tr>   
			<td width="50%">
				<table border="0" width="60%" align="center">
					<tr>
					<td width="35%">
						<img src="" id="adsimageimg"   width="200px" height="200px">
					</td>
					<td width="65%">
						<table width="100%" align="center" border="0">
							<tr>
								<td>广告的描述：</td>
								<td>
								 <textarea rows="2" class=f2_input name="adsPojo.adsDis" cols="35"></textarea>
								</td>
							</tr>
							<tr>
								<td>广告是否发布：</td>
							...
							<tr>
								...
								<td>
									...
									<input type="hidden" value="" id="updateadsimage"  name="imagesname" >
