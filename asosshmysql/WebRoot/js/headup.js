...
TB.headupheader = function() {
	...
	function f(W, V) {
		var z = g(W), K = z && z.q, x = z && z.search_type, E = z
				&& z.getElementsByTagName("label")[0], D = z && z.cat, S = g(
				"J_TSearchTabs").getElementsByTagName("li"), v = S.length, P = {}, I = false, F = false, y = "tsearch-tabs-active", N = function(
				Y) {
			for ( var X = 0; X < v; X++) {
	...
	function h() {
		...
		var y = document.getElementById("headupheader"), x = y ? y
	...
	return {
		...
		writeLoginInfo : function(z) {
			...
			var y = "";
			if (q) {
				y = '\u60a8\u597d\uff0c<a class="user-nick" href="../images/'
						+ G + '" target="_top">'
						+ i.escapeHTML(unescape(t.replace(/\\u/g, "%u")))
						+ "</a>\uff01";
				y += '<a id="J_Logout" href="../images/' + C
						+ '" target="_top">\u9000\u51fa</a>';
				y += '<a href="../images/' + E
						+ '" target="_top">\u7ad9\u5185\u4fe1';
				if (p) {
