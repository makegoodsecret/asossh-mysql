    ...
    $.jMapping = function(map_elm, options) {
        ...
        if (! ($(map_elm).data('jMapping'))) {
            ...
            var init = function(doUpdate) {
                ...
                info_window_selector = [settings.side_bar_selector, settings.location_selector, settings.info_window_selector].join(' ');
                ...
                if (doUpdate) {
                    ...
                    google.maps.event.addListener(markerManager, 'loaded',
                    function() {
                        updateMarkerManager();
            ...
            var getBounds = function(doUpdate) {
                ...
                for (var i = 1,
                len = places_data.length; i < len; i++) {
            ...
            var attachMapsEventToLinks = function() {
                var location_link_selector = [settings.side_bar_selector, settings.location_selector, settings.link_selector].join(' ');
                $(location_link_selector).live('click',
                function(e) {
                    e.preventDefault();
